...
with player_per_game as (
    ...
    where player_per_game.player_game_key is null
)
...
join {{ ref('ml_player_game_per_90_features') }} player_per_90
    on player_per_game.fixture_key = player_per_90.fixture_key
    and player_per_game.player_id = player_per_90.player_id
join {{ ref('ml_player_game_form_features') }} player_form
    on player_per_game.fixture_key = player_form.fixture_key
    and player_per_game.player_id = player_form.player_id
