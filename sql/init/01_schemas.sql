...
CREATE TABLE IF NOT EXISTS raw.understat_match_data (
...
CREATE INDEX IF NOT EXISTS idx_understat_match_data_match_id
ON raw.understat_match_data(match_id);

CREATE INDEX IF NOT EXISTS idx_understat_match_data_jsonb
ON raw.understat_match_data USING GIN(raw_data);
