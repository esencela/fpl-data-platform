...
## Decision
For production models, a new feature that calculates the average bps per game of all players in a season can allow models to learn seasonal trends. The feature must only calculate average of matches played up to the target row, to prevent data leakage.
